...
Start by warmly welcoming the student and asking what they'd like to learn about {user_topic}.`,
        ...
        abstract: '/Interview image/Dell.jpg'

    },
    {
        name: 'Mock Interview',
        icon: '/Interview image/Rajveer.jpg',
...
Begin by introducing yourself as the interviewer and start the interview process for the {user_topic} position.`,
        ...
        abstract: '/Interview image/Rajveer.jpg'
    },
    {
        name: 'Ques Ans Prep',
        icon: '/Interview image/Lafi.jpg',
...
Start by asking about their current knowledge level and what aspects of {user_topic} they need to focus on.`,
        ...
        abstract: '/Interview image/Lafi.jpg'
...
export const  CoachingExpert =[
    {
        name: 'Professor Dell',
        avatar: '/Interview image/Dell.jpg'
    },
    {
        name: 'Coach Lafi',
        avatar: '/Interview image/Lafi.jpg'
    },
    {
        name: 'Tutor Rajveer',
        avatar: '/Interview image/Rajveer.jpg'
    },
    {
        name: 'Guide Dell',
        avatar: '/Interview image/Dell.jpg'
