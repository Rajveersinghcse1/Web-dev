    ...
    if (compact) {
        return (
            <div className="flex items-center gap-2">
                ...
                <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium border backdrop-blur-sm ${getStatusColor(status.webSpeech)}`}>
        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 relative z-10">
                ...
                <StatusCard 
                    icon={Mic}
                    label="Speech Recog"
                    status={status.webSpeech}
                    statusText={status.webSpeech === null ? 'Checking...' : status.webSpeech ? 'Web Speech API' : 'Unavailable'}
                    delay={0.3}
                />
