...
import KPI1 from './Average';
import KPI2 from './Demokpi';
import DataPreview from './DataPreview'; // adjust the path if in a different folder
...
const DataFilter = () => {
  ...
  lightMode 
    ...
    : 'bg-white/10 border-white/20 text-white hover:border-blue-400 focus:bg-white/20 focus:border-blue-400 backdrop-blur-sm disabled:bg-white/5'
        ...
        {/* KPI Section */}
        <KPI1 filteredData={filteredData}/>
        <KPI2/>
        {/*Data Preview*/ }
        <DataPreview filteredData={filteredData} darkMode={lightMode} />
